...
public class PetaRMApungRahmawati extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_rmapung_rahmawati);
        ...
        if (isOnline()== true)
        {
            ...
            mainWebView.loadUrl("file:///android_asset/peta/petaapungrahmawati.html");
            ...
            mainWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int progress) {
                    PetaRMApungRahmawati.this.setTitle("Beranda");
                    PetaRMApungRahmawati.this.setProgress(progress * 100);
                    if (progress == 100) {
                        PetaRMApungRahmawati.this.setTitle(view.getTitle());
                    }
                }
            });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaRMApungRahmawati.this, HomeActivity.class);
        PetaRMApungRahmawati.this.finish();
