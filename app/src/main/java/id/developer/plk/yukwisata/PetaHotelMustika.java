...
public class PetaHotelMustika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_hotel_mustika);
        ...
        if (isOnline()== true)
        {
            ...
            mainWebView.loadUrl("file:///android_asset/peta/petahotelmustika.html");
            ...
            mainWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int progress) {
                    PetaHotelMustika.this.setTitle("Beranda");
                    PetaHotelMustika.this.setProgress(progress * 100);
                    if (progress == 100) {
                        PetaHotelMustika.this.setTitle(view.getTitle());
                    }
                }
            });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaHotelMustika.this, HomeActivity.class);
        PetaHotelMustika.this.finish();
