...
public class PetaRMWahyuUtama extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_rmwahyu_utama);
        ...
        if (isOnline()== true)
        {
            ...
            mainWebView.loadUrl("file:///android_asset/peta/petarmwahyuutama.html");
            ...
            mainWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int progress) {
                    PetaRMWahyuUtama.this.setTitle("Beranda");
                    PetaRMWahyuUtama.this.setProgress(progress * 100);
                    if (progress == 100) {
                        PetaRMWahyuUtama.this.setTitle(view.getTitle());
                    }
                }
            });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaRMWahyuUtama.this, HomeActivity.class);
        PetaRMWahyuUtama.this.finish();
