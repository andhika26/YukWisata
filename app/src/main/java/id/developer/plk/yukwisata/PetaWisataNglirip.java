...
public class PetaWisataNglirip extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_wisata_nglirip);
        ...
        if (isOnline())
    {
        ...
        mainWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int progress) {
                PetaWisataNglirip.this.setTitle("Beranda");
                PetaWisataNglirip.this.setProgress(progress * 100);
                if (progress == 100) {
                    PetaWisataNglirip.this.setTitle(view.getTitle());
                }
            }
        });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaWisataNglirip.this, HomeActivity.class);
        PetaWisataNglirip.this.finish();
