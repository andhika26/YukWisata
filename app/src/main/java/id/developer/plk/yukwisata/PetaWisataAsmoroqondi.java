...
public class PetaWisataAsmoroqondi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_wisata_asmoroqondi);
        ...
        if (isOnline())
        {
            ...
            mainWebView.loadUrl("file:///android_asset/peta/petamakamasmoroqondi.html");
            ...
            mainWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int progress) {
                    PetaWisataAsmoroqondi.this.setTitle("Beranda");
                    PetaWisataAsmoroqondi.this.setProgress(progress * 100);
                    if (progress == 100) {
                        PetaWisataAsmoroqondi.this.setTitle(view.getTitle());
                    }
                }
            });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaWisataAsmoroqondi.this, HomeActivity.class);
        PetaWisataAsmoroqondi.this.finish();
