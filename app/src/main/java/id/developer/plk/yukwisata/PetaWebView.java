...
public class PetaWebView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_web_view);
        ...
        if (isOnline()== true)
        {
            ...
            mainWebView.loadUrl("http://aplikasipemilihanobyekwisata.000webhostapp.com/mobile/");
			...
			public void onProgressChanged(WebView view, int progress) {
					PetaWebView.this.setTitle("Beranda");
					PetaWebView.this.setProgress(progress * 100);
					if (progress == 100) {
						PetaWebView.this.setTitle(view.getTitle());
					}
				}
			});
    ...
    private void kembali() {
        Intent intent = new Intent(PetaWebView.this, HomeActivity.class);
        PetaWebView.this.finish();
