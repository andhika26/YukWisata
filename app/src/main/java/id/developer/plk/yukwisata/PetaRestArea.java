...
public class PetaRestArea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_rest_area);
        ...
        if (isOnline()== true)
        {
            ...
            mainWebView.loadUrl("file:///android_asset/peta/petarestareatuban.html");
            ...
            mainWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int progress) {
                    PetaRestArea.this.setTitle("Beranda");
                    PetaRestArea.this.setProgress(progress * 100);
                    if (progress == 100) {
                        PetaRestArea.this.setTitle(view.getTitle());
                    }
                }
            });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaRestArea.this, HomeActivity.class);
        PetaRestArea.this.finish();
