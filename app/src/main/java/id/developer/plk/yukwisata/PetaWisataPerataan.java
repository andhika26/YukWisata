...
public class PetaWisataPerataan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_wisata_perataan);
        ...
        if (isOnline())
        {
            ...
            mainWebView.loadUrl("file:///android_asset/peta/petanglirip.html");
            ...
            mainWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int progress) {
                    PetaWisataPerataan.this.setTitle("Beranda");
                    PetaWisataPerataan.this.setProgress(progress * 100);
                    if (progress == 100) {
                        PetaWisataPerataan.this.setTitle(view.getTitle());
                    }
                }
            });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaWisataPerataan.this, HomeActivity.class);
        PetaWisataPerataan.this.finish();
