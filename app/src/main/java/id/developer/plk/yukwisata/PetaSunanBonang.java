...
public class PetaSunanBonang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peta_sunan_bonang);
        ...
        if (isOnline()== true)
        {
            ...
            mainWebView.loadUrl("file:///android_asset/peta/petangsunanbonang.html");
            ...
            mainWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int progress) {
                    PetaSunanBonang.this.setTitle("Beranda");
                    PetaSunanBonang.this.setProgress(progress * 100);
                    if (progress == 100) {
                        PetaSunanBonang.this.setTitle(view.getTitle());
                    }
                }
            });
    ...
    private void kembali() {
        Intent intent = new Intent(PetaSunanBonang.this, HomeActivity.class);
        PetaSunanBonang.this.finish();
